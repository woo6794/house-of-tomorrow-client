...
import ProfileMenuContainer from '../../../containers/Header/ProfileMenuContainer';
  ...
  return (
    <HeaderStyle>
      <HeaderContents>
        ...
        >
          <ProfileImg src={fakeHeaderData.profileImg} alt="profile" />
        </Profile>
      </HeaderContents>
    </HeaderStyle>
  );
